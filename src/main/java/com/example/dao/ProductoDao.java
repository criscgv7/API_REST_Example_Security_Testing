...
public interface ProductoDao extends JpaRepository<Producto, Long> {
    /**
     * Vamos a necesitar 3 metodos adicionales a los que genera el Crud repository
     * (interface), para:
     * 1. Recuperar lista de productos ordenados.
     * 2. Recuperar listado de productos páginado, es decir, que no traiga todos los productos,
     * sino de 10 en 10, de 20 en 20 etc.. 
     * 3. Recuperar las presentaciones con sus productos correspondientes
     * sin tener que realizar una subconsulta que sería menos eficiente que un join
     * a las entidades utilizando HQL(Hibernate Query Language).
     */
     ...
     */
     ...
     /**
      * El siguiente metodo recupera una página de producto
      */
      @Query(value = "select p from Producto p left join fetch p.presentacion" , 
      ...
      /** 
       * El metodo siguiente recupera un producto por el id y su presentación
      */
